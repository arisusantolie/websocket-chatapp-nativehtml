...
function connectToChat(userName) {
    ...
    stompClient.connect({"X-Authorization":"test"}, function (frame) {
...
function formMessageLauch(id,name,type){
    ...
    // let element = document.getElementById("child_message");
    if(isHistoryMessage!== null && isHistoryMessage.hasChildNodes()){
        isHistoryMessage.innerHTML=""; 
        // var hasChild = parentDiv.querySelector("#child_message") != null;
        // if(hasChild)
        // // let elementMessage = document.getElementById("child_message");
        // // isHistoryMessage.parentNode.removeChild(elementMessage);
        // isHistoryMessage.parentNode.removeChild(document.getElementById("child_message"))
    }
